...
![Diagrama que muestra el flujo del programa CGI: 1. El navegador envía URL al servidor. 2. El servidor utiliza CGI para ejecutar el programa. 3. Programa corre. 4. El programa envía la salida al servidor. 5. El servidor devuelve la salida al navegador.](https://academy.hackthebox.com/storage/modules/113/cgi.gif)
