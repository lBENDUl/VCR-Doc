...
Dado que el sistema operativo es Windows, nuestro objetivo es fuzz para scripts por lotes. Aunque fuzzing para scripts con una extensión .cmd no tiene éxito, descubrimos con éxito el archivo welcome.bat fuzzing para archivos con una extensión .bat.
...
Navegando a la URL descubierta en `http://10.129.204.227:8080/cgi/welcome.bat` devuelve un mensaje:
...
De la lista, podemos ver que el `PATH` la variable ha sido inestable, por lo que necesitaremos rutas de código duro en las solicitudes:
