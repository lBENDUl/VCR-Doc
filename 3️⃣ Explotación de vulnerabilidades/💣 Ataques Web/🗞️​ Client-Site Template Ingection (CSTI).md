...
Esta vulnerabilidad inyecta código malicioso en una plantilla de cliente que se ejecuta en el navegador del usuario en lugar del servidor.

Comúnmente se realiza este ataque para aprovecharnos después de un XSS.

Realizamos la comprobación en un formulación o un input donde nos deje ingresar texto:

```
{{7*7}}
```

Si nos da el resultado es porque es vulnerable.

Buscamos por esta vulnerabilidad para ver payloads que podamos usar teniendo en cuenta la tecnología por la que esta hecha la web.

Podemos irnos a la página de **HackTricks** 
https://book.hacktricks.wiki/en/index.html

**ES IGUAL A SSTI SOLO QUE EL CÓDIGO LO CARGA EL CLIENTE**
